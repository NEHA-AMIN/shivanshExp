...
class LegendrePositionEmbedding(nn.Module):
    """
    Legendre Polynomial Position Embeddings for Exp 5b.
    ...
    Key properties:
    - Orthogonality: ⟨P_n, P_m⟩ = δ_{nm} (Kronecker delta)
    - Normalized to [-1, 1] domain
    - Scaled by 1/√d_model for numerical stability
    - Non-trainable (registered as buffer)
    ...
    def verify_orthogonality(self, seq_len=100):
        ...
        # Extract diagonal (should be ~1/d_model after scaling)
...
if __name__ == "__main__":
    ...
    print("Testing Legendre Position Embeddings for Exp 5b...")
    ...
    # Create dummy input
    x = torch.randn(batch_size, seq_len, 7)  # 7 features for ETTh1
